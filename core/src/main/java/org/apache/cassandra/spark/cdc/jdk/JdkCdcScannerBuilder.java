                                                           ...
                                                           JdkCdcScannerBuilder.JdkCdcSortedStreamScanner>
{
    ...
    {
        this(0, Partitioner.Murmur3Partitioner, Stats.DoNothingStats.INSTANCE, rangeFilter, offsetFilter, minimumReplicasFunc, watermarker, jobId, executorService, false, logs, 5, cassandraSource);
    }
