...
public class CqlSet extends org.apache.cassandra.spark.data.fourzero.complex.CqlSet implements SparkCqlField.ComplexTrait, SparkCqlField.SparkSet, SparkCqlField.ListTrait
{
    public CqlSet(CqlField.CqlSet type)
    {
        super(FourZeroSparkCqlField.decorate(type.type()));
    }
