...
public abstract class SSTablesSupplier
{
    ...
    {
        T openReader(final DataLayer.SSTable ssTable) throws IOException;
    }
     ...
     */
    public abstract <T extends SparkSSTableReader> Set<T> openAll(final ReaderOpener<T> readerOpener);
}
