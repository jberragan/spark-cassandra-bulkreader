...
public class JdkValueMetadata extends ValueWithMetadata implements RowSource<Column>
{
    public JdkValueMetadata(String columnName,
                            String columnType,
                            ByteBuffer value)
    {
    ...
    public Column toRow()
    {
        return new Column(columnName, FourZeroTypes.INSTANCE.parseType(columnType), getValue());
    }
}
